...
def dfs_search(problem):
    ...
    # Initialize explored list, frontier stack, and path list
    explored = []
    frontier = deque([start_state])  # Use deque as stack
    path = []
    parent = {start_state: None}
    goal_state = None

    while frontier:
        state = frontier.pop()  # Pop from the stack (LIFO)
        ...
        if state not in explored:
            ...
            # Add neighbors to the frontier (stack) for exploration
